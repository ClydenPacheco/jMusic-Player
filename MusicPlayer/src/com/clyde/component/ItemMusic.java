...
public class ItemMusic extends javax.swing.JPanel {
    ...
    public void setPlay(boolean play) {
        ...
        if (play) {
            lbIcon.setText("");
            lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/clyde/icon/playing.png")));
            ...
            System.out.println(lbText.getText());
        } else {
            lbIcon.setIcon(null);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(lbTime, javax.swing.GroupLayout.DEFAULT_SIZE, 51, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbIcon, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
